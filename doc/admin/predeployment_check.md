...
'disable_vfio' in the
[server config file](https://github.com/mjmac/soad/blob/master/utils/config/daos_server.yml#L109),
...
https://github.com/mjmac/soad/blob/master/utils/systemd/daos_server.service#L16.

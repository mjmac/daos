...
There is a tool available to estimate the metadata overhead. It is described on the <a href="https://github.com/mjmac/soad/blob/master/src/client/storage_estimator/README.md">storage estimator</a> section.
